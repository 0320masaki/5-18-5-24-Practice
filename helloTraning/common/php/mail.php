...
$require = array('お名前','郵便番号','都道府県','市区町村','電話番号','メールアドレス');
...
$re_subject = "【WEBサイト制作科】ご応募ありがとうございましす";
...
ご応募ありがとうございます。
このメールは自動返信メールです。
内容を確認の上、担当者より改めてご連絡致しますので
今しばらくお待ちください。

尚、このメールにお心当たりの無い方は【メールアドレス】まで
ご連絡をお願い致します。
...
<br />
<a href="../../index.html">トップページへ戻る&raquo;</a></p>
</div>
<?php copyright(); ?>
